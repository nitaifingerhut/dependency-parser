...
# Run the experiments
python train.py --num-epochs 50 --batch-size 032 --optimizer Adam --lr 0.001 --model-params lstm_num_layers=2 lstm_hidden_dim=128 lstm_dropout 0.05 activation_type relu --name 20-6_b_032_lr_0.001_drop_0.05_atype_relu
